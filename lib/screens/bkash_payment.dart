...
class BkashPaymentScreen extends StatelessWidget {
  final String amount;
  const BkashPaymentScreen({super.key, required this.amount});

  @override
  Widget build(BuildContext context) {
    const String targetNumber = "01611184808"; //Bkash target number
    return Scaffold(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Image.asset("assets/images/bkash.png", height: 70),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          // ইনস্ট্রাকশন স্টেপস উইথ বোল্ড ইংলিশ টেক্সট
                          _buildStep(
                            RichText(
                              text: TextSpan(
                                style: const TextStyle(
  ...
  // ইংলিশ টেক্সটকে বোল্ড ও লাইট করার জন্য Helper
  static TextSpan _boldSpan(String text) {
    return TextSpan(
      text: text,
      style: const TextStyle(
        fontWeight: FontWeight.w800, // বোল্ড
        color: Color(
          0xFFFFEB3B,
        ), // হালকা লুকের জন্য সাদা কালারই বোল্ড হিসেবে ভালো ফুটবে
        letterSpacing: 0.5,
      ),
    );
  }

  // ইনস্ট্রাকশন স্টেপ উইজেট (বর্ডার লাইনসহ)
  Widget _buildStep(
    Widget content, {
    bool isLast = false,
    bool hasLine = true,
            ...
            : Border(
                bottom: BorderSide(
                  color: const Color.fromARGB(
                    ...
                    0,
                    0,
                  ).withValues(alpha: 0.15), // হালকা সাদা বর্ডার লাইন
                  width: 0.8,
                ),
              ),
      ),
